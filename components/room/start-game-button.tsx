...
//   const { selectedCardIds, room, userCards } = useRoomStore()
//   const { balance, setBalance } = usePaymentStore()
//   const router = useRouter()

//   const { startGame, connected } = useWebSocketEvents({
//     roomId: room?.id || "",
//     enabled: !!room,
//   })
...
//         `You need $${totalCost.toFixed(2)} but only have $${balance.available.toFixed(2)}`,
//       )
//       return
//     }

//     if (!isPracticeRoom && !connected) {
//       console.log("Connection Required: Please wait for connection to be established")
//       return
//     }
...
//       console.log(
//         `${isPracticeRoom ? "Practice Game Started!" : "Game Started!"}`,
//         `Successfully joined with ${selectedCards} card${selectedCards > 1 ? "s" : ""}${isPracticeRoom ? " - Practice mode, no prizes awarded" : ""}`,
//       )
...
//       console.log("Game Start Failed: Please try again or contact support")
//     } finally {
